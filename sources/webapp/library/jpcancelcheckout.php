<jm:modal title="<?php echo $class->getString('CANCELCHECKOUT');?>" icon="cancelcheckout.png">
<?php $class->init();?>
...
<div class="buttons">
<jm:button action="postServerEvent('cancelcheckout', 'return', null, 'onOk', null);" nlsid="OK" src="ok_16.png" cssclass="right"/>
