<jm:modal title="<?php echo $class->getString('BOOKMARK');?>" icon="bookmark.png">
<?php $class->init();?>
...
<div class="buttons">
<jm:button action="postServerEvent('bookmark', 'return', null, 'onOk', null);" nlsid="OK" src="ok_16.png" cssclass="right"/>
