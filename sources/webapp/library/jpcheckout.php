<jm:modal title="<?php echo $class->getString('CHECKOUT');?>" icon="checkedout.png">
<?php $class->init();?>
...
<div class="buttons">
<jm:button action="postServerEvent('checkout', 'return', null, 'onOk', null);" nlsid="OK" src="ok_16.png" cssclass="right"/>
