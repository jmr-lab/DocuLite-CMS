<jm:modal title="<?php echo $class->getString('COPY');?>" icon="cut.png">
<?php $class->init();?>
...
<div class="buttons">
<jm:button action="postServerEvent('copygroup', 'return', null, 'onOk', null);" nlsid="OK" src="ok_16.png" cssclass="right"/>
