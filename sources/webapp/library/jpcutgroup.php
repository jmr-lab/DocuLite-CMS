<jm:modal title="<?php echo $class->getString('CUT');?>" icon="cut.png">
<?php $class->init();?>
...
<div class="buttons">
<jm:button action="postServerEvent('cutgroup', 'return', null, 'onOk', null);" nlsid="OK" src="ok_16.png" cssclass="right"/>
