<jm:modal title="<?php echo $class->getString('DELETE');?>" icon="recyclebin.png">
<?php $class->init();?>
...
<div class="buttons">
<jm:button action="postServerEvent('deletegroup', 'return', null, 'onOk', null);" nlsid="OK" src="ok_16.png" cssclass="right"/>
