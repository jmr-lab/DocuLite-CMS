<?php
/**
 * An Estancia JwDataTextAreaValueTag tag.
 *
 ...
 * @version		3.0
 */
class JwDataTextAreaValueTag extends JwTag
{
	/**
	 ...
	 *
	 * Otherwise :
	 * 	<textarea style="width: 450px;" class="label" rows="4">Text</textarea>
	 *
	 * @access	public
	...
	public static function render($tag)
	{
		...
		if (isset($attributes['readonly']) && $attributes['readonly'] == 'false')
		{
			...
			echo 'class="'.$class.'" rows="4">'.$attributes['value'].'</textarea>';
		}
		else
		{
			echo '<span ';
