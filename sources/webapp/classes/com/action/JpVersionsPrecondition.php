<?php
/**
 * The Versions Precondition class.
 *
 * @package		com.action
...
class JpVersionsPrecondition
{
	 ...
	 */
	public function JpVersionsPrecondition() {}
	...
	public function queryExecute($session, $object)
	{
		...
		// JcLogger::info('BEGIN - '.$object['r_object_id']);
		// foreach ($object as $key => $value)	{JcLogger::info('object['.$key.'] : '.$value);}
		// JcLogger::info('END - '.$object['r_object_id']);
