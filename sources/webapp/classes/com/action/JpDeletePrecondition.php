...
class JpDeletePrecondition
{
	 ...
	 */
	public function JpDeletePrecondition() {}
...
//		JcLogger::info('$component : '.$component);
		$allowed = array('clipboard', 'favorites');
		$forbidden = array('usermanagement', 'security');
		if (in_array($component, $allowed))	{return true;}
		if (in_array($component, $forbidden))	{return false;}
...
//		if (in_array($object->getValue('r_object_type'), array('jm_group', 'jm_user', 'jm_acl', 'jm_format', 'jm_type', 'jm_workflow')))	{return false;}
		// Otherwise
		if ($object->getValue('r_accessor_permit') == 7)	{return true;}
