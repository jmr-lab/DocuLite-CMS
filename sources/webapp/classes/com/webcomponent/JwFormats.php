 ...
 * @version		3.0
 */
class JwFormats extends JwObjectList
{
	/**
	 * List of columns
	 *
	 ...
	 * @var		array
	 */
	protected $columns = array('icon', 'object_name', 'properties', 'dos_extension');
	...
	public function init()
	{
		...
		$sql = "SELECT SQL_CALC_FOUND_ROWS r_object_id, name AS object_name, description AS dos_extension, '3' AS r_accessor_permit, '' AS owner_name,
