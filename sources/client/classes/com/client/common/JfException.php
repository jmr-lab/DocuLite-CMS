...
class JfException extends Exception
{
	...
	* @var int
	*/
	public static $JF_EXCEPTION_FATAL = 0;
	...
	* @var int
	*/
	public static $JF_EXCEPTION_ERROR = 1;
	...
	* @var int
	*/
	public static $JF_EXCEPTION_WARNING = 2;
	...
	* @var int
	*/
	public static $JF_EXCEPTION_INFO = 3;
	...
	* @var int
	*/
	public static $JF_EXCEPTION_DEBUG = 4;
	...
	*/
	...
	public function append($message)
	{
		...
		JfLogger::write($message, $this->getCode());
	}
	...
	{
//		return __CLASS__ . ': [{'.$this->code.'}]: {'.$this->getStackTraceAsString().'}\n';
